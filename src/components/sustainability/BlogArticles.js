...
const BlogArticles = () => {
  ...
  const content = {
    pt: {
      ...
      resume: (
        <>
          A IA tem o potencial de revolucionar a forma como lidamos com as
          mudanças climáticas, fornecendo ferramentas para{" "}
          <a
          ...
          , dentre outros. No entanto, para que sua contribuição seja
          maximizada, é necessário superar os desafios atuais, expandindo a
          disponibilidade de dados, integrando modelos de IA com abordagens
          tradicionais e garantindo que os desenvolvimentos sejam eticamente
          sustentáveis. A implementação de políticas públicas que apoiem o uso
          responsável da IA e promovam a colaboração entre instituições pode
          acelerar o desenvolvimento de tecnologias mais robustas e acessíveis,
          consolidando a IA como um dos pilares da sustentabilidade ambiental
      ...
      text: {
        ...
        t1: (
          <>
            "A eficiência energética é uma das áreas mais promissoras para a
            aplicação da IA no combate às mudanças climáticas. Em sistemas de
            energia, a IA pode otimizar o consumo, prever demandas e integrar
            fontes renováveis de forma mais eficaz.
            <Link
              className="text-blue-600 hover:underline"
            ...
            destaca que a IA possibilita previsões de demanda energética que
            ajudam a reduzir o uso de combustíveis fósseis e a integrar fontes
        ...
        t2: (
          <>
            ...
            enfatizam que a IA, ao ser combinada com redes inteligentes (smart
            grids), pode reduzir o custo de eletricidade em até 20%, além de
            melhorar a confiabilidade e a resiliência das redes. Um exemplo é o
            uso de IA para gerenciar o fluxo de energia entre diversas fontes,
            garantindo o equilíbrio entre oferta e demanda, o que é essencial
            para uma rede sustentável.
          </>
        ),
      },
      text2: {
        ...
        t1: (
          <>
            A precisão na previsão climática é outra área onde a IA oferece
            contribuições significativas. Graças a algoritmos de aprendizado
            profundo e análise de grandes volumes de dados meteorológicos, a IA
            consegue fornecer previsões mais detalhadas e em tempo real sobre
            eventos climáticos extremos, permitindo melhor preparação e resposta
            a esses fenômenos.
            <Link
              className="text-blue-600 hover:underline"
              href="/pdfs/AI-based-Solutions-for-Climate-Change.pdf"
            ...
            destacam que cerca de 70% do setor de gás natural já utiliza IA para
            aprimorar a precisão de previsões meteorológicas, auxiliando na
            prevenção de desastres naturais.
          </>
        ),
        t2: (
          <>
            Além disso, a IA permite monitorar emissões de GEE em tempo real,
            utilizando sensores e imagens de satélite. Isso facilita a
            identificação de fontes de emissão, como vazamentos de metano em
            infraestruturas industriais, e possibilita a implementação rápida de
            medidas corretivas
            <Link
              className="text-blue-600 hover:underline"
              href="/pdfs/AI-based-Solutions-for-Climate-Change.pdf"
            ...
            A combinação de dados climáticos e análise preditiva também é uma
            estratégia-chave para aprimorar modelos climáticos e, assim,
            informar melhor os formuladores de políticas públicas.
          </>
        ),
      },
      quote: {
      ...
      text4: {
        ...
        t2: (
          <>
            ...
            sugere o desenvolvimento de políticas públicas para fomentar o uso
            da IA em iniciativas climáticas, promovendo também o
            compartilhamento de dados climáticos entre instituições. Incentivos
            para pesquisa e desenvolvimento de IA focada em sustentabilidade são
            cruciais para reduzir barreiras financeiras e técnicas, enquanto a
            criação de diretrizes éticas pode mitigar preocupações com
    ...
    en: {
      ...
      resume: (
        <>
          AI has the potential to revolutionize the way we address climate
          change by providing tools for{" "}
          <a
            href="#EnergyEfficiency"
            onClick={scrollTo("EnergyEfficiency")}
          ...
          , among others. However, to maximize its contribution, it is necessary
          to overcome current challenges, expand data availability, integrate AI
          models with traditional approaches, and ensure that developments are
          ethically sustainable. The implementation of public policies that
          support the responsible use of AI and promote collaboration between
          institutions can accelerate the development of more robust and
          accessible technologies, solidifying AI as one of the pillars of
      ...
      text: {
        ...
        t1: (
          <>
            Energy efficiency is one of the most promising areas for applying AI
            in climate change mitigation. In energy systems, AI can optimize
            consumption, forecast demand, and integrate renewable sources more
            effectively.
            <Link
              className="text-blue-600 hover:underline"
              href="/pdfs/AI-based-Solutions-for-Climate-Change.pdf"
            ...
            highlights that AI enables energy demand forecasts that help reduce
            fossil fuel reliance and integrate renewable energy sources.
          </>
        ),
        t2: (
          <>
            ...
            emphasize that AI, when combined with smart grids, can reduce
            electricity costs by up to 20%, while improving grid reliability and
            resilience. An example includes AI's ability to manage energy flow
            among various sources, ensuring balance between supply and demand,
            essential for a sustainable grid.
          </>
        ),
      },
      text2: {
        ...
        t1: (
          <>
            Accuracy in climate forecasting is another area where AI offers
            significant contributions. Through deep learning algorithms and
            analysis of vast meteorological data, AI provides detailed,
            real-time forecasts on extreme weather events, enabling better
            preparation and response to such phenomena.
            <Link
              className="text-blue-600 hover:underline"
              href="/pdfs/AI-based-Solutions-for-Climate-Change.pdf"
              target="_blank"
            ...
            note that approximately 70% of the natural gas sector already uses
            AI to improve weather forecast accuracy, aiding in natural disaster
            prevention.
          </>
        ),
        t2: (
          <>
            Additionally, AI enables real-time GHG emissions monitoring using
            sensors and satellite imagery. This facilitates the identification
            of emission sources, such as methane leaks in industrial
            infrastructure, and allows for the swift implementation of
            corrective measures
            <Link
              className="text-blue-600 hover:underline"
              href="/pdfs/AI-based-Solutions-for-Climate-Change.pdf"
            ...
            Combining climate data and predictive analysis is also a key
            strategy for enhancing climate models and, thereby, better informing
            policymakers.
          </>
        ),
      },
      ...
      text4: {
        ...
        t2: (
          <>
            ...
            suggests developing public policies to promote AI use in climate
            initiatives, encouraging the sharing of climate data across
            institutions. Funding for research and development of AI focused on
            sustainability is crucial to reducing financial and technical
            barriers, while ethical guidelines are needed to address privacy and
            security concerns.
          </>
        ),
      },
          ...
          <div className="space-y-5 md:space-y-8">
            ...
            >
              <h3 className="text-2xl font-semibold font-roboto">
                {content[language].text.title}
              </h3>
              <p className="text-lg text-neutral-700 ">
                {content[language].text.t1}
              </p>
              <p className="text-lg text-neutral-700 ">
                {content[language].text.t2}
              </p>
            </div>
            <figure>
            ...
            >
              <h3 className="text-2xl font-semibold font-roboto">
                {content[language].text2.title}
              </h3>
              <p className="text-lg text-neutral-700 ">
                {content[language].text2.t1}
              </p>
            </div>
            <p className="text-lg text-neutral-700 ">
              {content[language].text2.t2}
            </p>
            ...
            >
              <h3 className="text-2xl font-semibold font-roboto">
                {content[language].text3.title}
              </h3>
              <p className="text-lg text-neutral-700">
                {content[language].text3.t1}
              </p>
              <p className="text-lg text-neutral-700">
                {content[language].text3.t2}
              </p>
            </div>
            <figure>
              <img
            ...
            <div className="space-y-3">
              <h3 className="text-2xl font-semibold font-roboto">
                {content[language].text4.title}
              </h3>

              <p className="text-lg text-neutral-700 ">
                {content[language].text4.t1}
              </p>
              <p className="text-lg text-neutral-700">
                {content[language].text4.t2}
              </p>
            </div>
            <div className="space-y-3">
              <p className="text-2xl font-semibold font-roboto">
                {content[language].conclusion.title}
              </p>
              <p className="text-lg text-neutral-700">
                {content[language].conclusion.text}
              </p>
            </div>
          </div>
        </div>
