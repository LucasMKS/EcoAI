...
export function ExpandableCardDemo() {
  ...
  return (<div className="bg-zinc-900 mx-72 rounded-2xl shadow-2xl shadow-zinc-600 ">
    <AnimatePresence>
      ...
      {active && typeof active === "object" ? (
        <div className="fixed inset-0  grid place-items-center z-[100]">
          ...
          <motion.div
            ...
            ref={ref}
            className="w-full max-w-[500px] h-full md:h-fit md:max-h-[90%] flex flex-col bg-zinc-900 sm:rounded-3xl overflow-hidden">
    ...
    <ul
      className="max-w-5xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 items-start gap-4">
      {cards.map((card, index) => (
        <motion.div
          layoutId={`card-${card.title}-${id}`}
          key={card.title}
          onClick={() => setActive(card)}
          className="p-4 flex flex-col hover:bg-zinc-800 rounded-2xl cursor-pointer">
